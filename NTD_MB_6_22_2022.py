...
wd_sc_id2 = weekday_df['2021-11-21' : '2021-12-31']
wd_sc_id2_VOMS = wd_sc_id2['daily_VOM'].max()
wd_sc_id2_num = len(wd_sc_id2)

wd_sc_id3 = weekday_df['2022-1-1' : '2022-2-25']
...
sat_sc_id2 = sat_df['2021-11-21' : '2021-12-31']
sat_sc_id2_VOMS = sat_sc_id2['daily_VOM'].max()
sat_sc_id2_num = len(sat_sc_id2)

sat_sc_id3 = sat_df['2022-1-1' : '2022-2-25']
...
san_sc_id2 = san_df['2021-11-21' : '2021-12-31']
san_sc_id2_VOMS = san_sc_id2['daily_VOM'].max()
san_sc_id2_num = len(san_sc_id2)

san_sc_id3 = san_df['2022-1-1' : '2022-2-25']
...
atypical_sc_id2 = atypical_df['2021-11-21' : '2021-12-31']
atypical_sc_id2_num = len(atypical_sc_id2)

atypical_sc_id3 = atypical_df['2022-1-1' : '2022-2-25']
...
sc_data = {'Service Change ID':[1,2,3,4,5], 
           'Change Date': ['10/1/2021', '11/21/2021', '1/1/2022', '2/26/2022', '4/24/2022'],
           'End Date':   ['11/20/2021', '12/31/2021', '2/25/2022', '4/23/2022', '9/30/2022'],
